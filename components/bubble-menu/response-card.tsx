...
import { TrashIcon, RotateCwIcon, PlusIcon, ReplaceIcon } from "lucide-react";
...
export const ResponseCard = ({ command, selected, response, setResponse, fullMarkdown, editor, handleSubmit }: ResponseCardProps) => {
    if (!editor) {
        return null;
    }
