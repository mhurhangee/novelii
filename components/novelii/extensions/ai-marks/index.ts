...
function createAiMark(name: string, color: string, extraCSS = '') {
  return Mark.create({
    name,
    addOptions() {
...
export const AiInsert = createAiMark(
  'ai_insert',
  'var(--ai-insert-bg)',
  'color: var(--foreground);'
)
export const AiDelete = createAiMark(
  'ai_delete',
  'var(--ai-delete-bg)',
  'text-decoration: line-through; color: var(--foreground);'
)
export const AiComment = createAiMark(
  'ai_comment',
  'var(--ai-comment-bg)',
  'color: var(--foreground);'
)
