...
const documentTypeOptions = [
  ...
  { label: 'Article', value: 'article', icon: Newspaper, prompt: 'Write as an article.' },
  {
    ...
    value: 'social',
    icon: MessageCircle,
    prompt: 'Write as a social media post.',
  },
  ...
  { label: 'Whitepaper', value: 'whitepaper', icon: FileText, prompt: 'Write as a whitepaper.' },
  {
    ...
    value: 'qa',
    icon: HelpCircle,
    prompt: 'Present as a Q&A or interview.',
  },
  {
    label: 'Case Study',
    value: 'case_study',
    icon: FileSignature,
    prompt: 'Present as a case study.',
  },
  {
    label: 'Step-by-Step Guide',
    value: 'guide',
    icon: MoveDown,
    prompt: 'Write as a step-by-step guide.',
  },
  ...
  { label: 'Script', value: 'script', icon: Film, prompt: 'Write as a script.' },
  {
    ...
    value: 'table_chart',
    icon: Table,
    prompt: 'Present information in tables or charts.',
  },
]
