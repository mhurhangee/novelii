...
export function PromptBuilder({ aiSettings, setAiSettings }: PromptBuilderProps) {
  ...
  // Update customPrompt whenever generatedPrompt changes and we're not in editing mode
  useEffect(() => {
    if (!isEditing) {
      const updatedSettings = { ...aiSettings, customPrompt: generatedPrompt }
      setAiSettings(updatedSettings)
    }
  }, [generatedPrompt, isEditing, aiSettings, setAiSettings])
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] w-[90vw] !max-w-none overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill out the form below to automatically generate a customized AI prompt. You can edit
            the final prompt as needed.
          </DialogDescription>
        </DialogHeader>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={value => handleSettingChange('audience', value)}
                    >
                      <SelectTrigger className="w-full">
              ...
              <CardContent>
                <div className="space-y-2">
                  <Label htmlFor="prompt">
                    {isEditing ? 'Custom Prompt (Edited)' : 'Auto-Generated Prompt'}
                  </Label>
                  <Textarea
                    id="prompt"
                    value={displayPrompt}
                  ...
                  {isEditing && (
                    <p className="text-muted-foreground text-sm">
                      You have customized this prompt. Changes to the form above will not update it
                      automatically.
                    </p>
                  )}
                </div>
