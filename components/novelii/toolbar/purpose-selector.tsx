import { Info, ThumbsUp, Music, BookOpenCheck, HelpCircle, Lightbulb, MailQuestion, Megaphone, FileText, MessageSquareWarning } from 'lucide-react'
...
const purposeOptions = [
    ...
    { label: "Instruct", value: "instruct", icon: BookOpenCheck, prompt: "Write to instruct or teach the reader." },
    ...
    { label: "Announce", value: "announce", icon: Megaphone, prompt: "Write to make an announcement." },
    { label: "Summarize", value: "summarize", icon: FileText, prompt: "Write a summary." },
    { label: "Critique", value: "critique", icon: MessageSquareWarning, prompt: "Write a critique or analysis." },
  ];

export function PurposeSelector({ aiSettings, setAiSettings }: { aiSettings: aiSettings, setAiSettings: (aiSettings: aiSettings) => void }) {
  return (
    <GenericSelector
