import { ShieldCheck, Smile, Briefcase, Handshake, ThumbsUp, Minus, Laugh, Heart, Megaphone, ArrowUpRight, BarChart2, Eye, Scissors, Layers, MessageSquare, BookOpen } from 'lucide-react'
...
const toneStyleOptions = [
    ...
    { label: "Professional", value: "professional", icon: Briefcase, prompt: "Use a professional tone." },
    ...
    { label: "Encouraging", value: "encouraging", icon: ArrowUpRight, prompt: "Use an encouraging tone." },
    { label: "Analytical", value: "analytical", icon: BarChart2, prompt: "Be analytical and logical." },
    ...
    { label: "Conversational", value: "conversational", icon: MessageSquare, prompt: "Use a conversational style." },
    { label: "Storytelling", value: "storytelling", icon: BookOpen, prompt: "Tell a story." },
  ];

export function ToneSelector({ aiSettings, setAiSettings }: { aiSettings: aiSettings, setAiSettings: (aiSettings: aiSettings) => void }) {
  return (
    <GenericSelector
